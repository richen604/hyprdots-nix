...
echo "This script will set up Ubuntu for Hydenix."
...
echo "Setting up Ubuntu with the following configuration:"
...
echo "Ubuntu setup complete. Please reboot the system."
